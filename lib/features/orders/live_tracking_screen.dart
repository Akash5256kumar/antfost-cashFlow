          ...
          Center(
            child: Text(
              ...
              style: AppTextStyles.screenTitle(
                context,
              ).copyWith(color: const Color(0xFF1E1B4B)),
            ),
          ),
                    ...
                    ConstrainedBox(
                      constraints: BoxConstraints(
                        maxHeight:
                            ...
                            0.65, // Limit bottom sheet height so map always has space
                      ),
                      child: Container(
                        decoration: BoxDecoration(
                          color: Colors.white,
                                ...
                                ..._trucks.map((t) {
                                  ...
                                  return Padding(
                                    ...
                                    child: InkWell(
                                      onTap: () => Navigator.of(
                                        context,
                                      ).pushNamed(AppRoutes.siteCheckpoint),
